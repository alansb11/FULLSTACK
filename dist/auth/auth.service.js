...
let AuthService = class AuthService {
    ...
    async register(dto) {
        ...
        if (dto.rol === usuario_entity_1.Rol.ESTUDIANTE && !dto.idEstudiante) {
            throw new common_1.BadRequestException('idEstudiante es requerido para el rol estudiante');
        }
        ...
        const usuario = this.usuarioRepo.create({
            ...
            rol: dto.rol,
            idEstudiante: dto.rol === usuario_entity_1.Rol.ESTUDIANTE ? dto.idEstudiante : null,
        });
